// Deep imports keep this headless-safe (the @dronecad/app barrel pulls in DOM-bound
// web components). Each of these node modules only depends on @dronecad/core.
import { BoxNode } from "@dronecad/app/src/bodys/box";
import { ConeNode } from "@dronecad/app/src/bodys/cone";
import { CylinderNode } from "@dronecad/app/src/bodys/cylinder";
import { ExtrudeNode } from "@dronecad/app/src/bodys/extrude";
import { PipeNode } from "@dronecad/app/src/bodys/pipe";
import { PyramidNode } from "@dronecad/app/src/bodys/pyramid";
import { RevolvedNode } from "@dronecad/app/src/bodys/revolve";
import { SphereNode } from "@dronecad/app/src/bodys/sphere";
import { SweepedNode } from "@dronecad/app/src/bodys/sweep";
import {
    EditableShapeNode,
    type IDocument,
    type INode,
