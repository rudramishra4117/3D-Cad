...
import { ThreeOriginObject } from "./threeOriginObject";
import { ThreeReferencePlaneObject } from "./threeReferencePlaneObject";
...
export class ThreeVisualContext implements IVisualContext {
    ...
    private displayNode(node: INode) {
        ...
        } else if (node.constructor.name === "OriginNode") {
            visualObject = new ThreeOriginObject(this, node as any);
        } else if (node.constructor.name === "ReferencePlaneNode") {
            visualObject = new ThreeReferencePlaneObject(this, node as any);
