import { Binding, type IDocument, Localize, type Property, PubSub, Transaction } from "@dronecad/core";
import { ColorConverter, div, input, label } from "@dronecad/element";
...
customElements.define("dronecad-color-property", ColorProperty);
