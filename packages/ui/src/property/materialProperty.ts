...
import { button, ColorConverter, collection, div, span, UrlStringConverter } from "@dronecad/element";
...
customElements.define("dronecad-material-property", MaterialProperty);
