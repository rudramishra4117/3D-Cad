import { type FloatPanelOptions, getCurrentApplication, Localize } from "@dronecad/core";
import { div, label, svg } from "@dronecad/element";
...
customElements.define("dronecad-float-panel", FloatPanel);
