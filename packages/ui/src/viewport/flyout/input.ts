import { I18n, type I18nKeys, type IDisposable, Localize, type Result } from "@dronecad/core";
import { input, label } from "@dronecad/element";
...
customElements.define("dronecad-input", Input);
