import { I18n, type I18nKeys, type INode, NodeUtils, PubSub } from "@dronecad/core";
import { a, svg } from "@dronecad/element";
...
customElements.define("dronecad-toolbar", ToolBar);
