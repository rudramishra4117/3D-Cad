import { type DialogButton, getCurrentApplication, I18n, type I18nKeys } from "@dronecad/core";
import { button, div } from "@dronecad/element";
...
export function showDialog(title: I18nKeys, content: HTMLElement, buttons?: DialogButton[] | (() => void)) {
    ...
    dialog.appendChild(
        div(
            ...
            div({ className: style.title }, I18n.translate(title) ?? "dronecad"),
