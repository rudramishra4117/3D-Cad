...
describe("Expander", () => {
    ...
    describe("constructor", () => {
        ...
        test("should start in expanded state", () => {
            ...
            const icon = expander.querySelector(`.${style.expanderIcon}`);
            expect(icon?.classList.contains("ph-caret-down")).toBe(true);
        });
    ...
    describe("expand/collapse toggle", () => {
        test("should collapse when expander icon is clicked", () => {
            ...
            expect(icon.classList.contains("ph-caret-right")).toBe(true);
        });
    ...
    describe("customElements.define", () => {
        test("should define custom element", () => {
            expect(customElements.get("dronecad-expander")).toBe(Expander);
        });
    });
    ...
    describe("structure", () => {
        ...
        test("should have correct expander icon class", () => {
            ...
            const icon = expander.querySelector(`.${style.expanderIcon}`);
            expect(icon?.classList.contains(style.expanderIcon)).toBe(true);
        });
    });
});
