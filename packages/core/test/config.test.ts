...
describe("Config", () => {
    ...
    describe("language", () => {
        ...
        test("should set language", () => {
            I18n.addLanguage({ language: "zh-CN", display: "Chinese", translation: {} as any });
    ...
    describe("readFromStorage", () => {
        test("should call setPrivateValue for each property", () => {
            I18n.addLanguage({ language: "en-US", display: "English US", translation: {} as any });
            Config.instance.init("testRead");
            const testData = {
                language: "en-US",
                navigation3D: "Blender",
            };
            localStorageMock["dronecad.app.testRead"] = JSON.stringify(testData);
        ...
        test("should handle empty storage", () => {
            Config.instance.init("config");
            localStorageMock["dronecad.app.config"] = "{}";
    ...
    describe("saveToStorage", () => {
        test("should call ObjectStorage.setValue", () => {
            I18n.addLanguage({ language: "fr-FR", display: "French", translation: {} as any });
            Config.instance.init("testSave");
            Config.instance.language = "fr-FR";

            Config.instance.saveToStorage();

            const stored = localStorageMock["dronecad.app.testSave"];
