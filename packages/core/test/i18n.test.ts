...
describe("I18n", () => {
    ...
    describe("set", () => {
        test("should set textContent on element", () => {
            ...
            expect(element.dataset["dronecad18n"]).toBe("common.cancel_:_textContent");
        });
        ...
        test("should set title on element", () => {
            ...
            expect(element.dataset["dronecad18n"]).toBe("common.confirm_:_title");
        });
    ...
    describe("changeLanguage", () => {
        ...
        test("should update all elements with data-dronecad18n", () => {
            I18n.addLanguage(mockLocaleEn);
            I18n.addLanguage(mockLocaleZh);
