import { type IApplication, Logger } from "@dronecad/core";
import type { DataType, DocumentState, RequestMessage } from "@dronecad/mcp/src/bridge/protocol";
import { collectShapes, measureDocument, serializeDocument } from "@dronecad/mcp/src/pipeline";
import { runProgram } from "@dronecad/mcp/src/program/interpreter";
...
export function connectLive(application: IApplication, url: string): void {
    ...
    (window as unknown as { __dronecadLive: LiveStatus }).__dronecadLive = status;
